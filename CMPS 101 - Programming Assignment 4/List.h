...
#ifndef CMPS_101_PROGRAMMING_ASSIGNMENT_4_LIST_H
#define CMPS_101_PROGRAMMING_ASSIGNMENT_4_LIST_H
...
// getIndex()
// Returns the getIndex of the cursor on the list, -1 if cursor is undefined
// Pre: !isEmpty(L)
int getIndex(List L);
...
#endif //CMPS_101_PROGRAMMING_ASSIGNMENT_4_LIST_H